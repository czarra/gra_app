...
public class MyGameRecyclerViewAdapter extends RecyclerView.Adapter<MyGameRecyclerViewAdapter.ViewHolder> {
    ...
    private final GameFragment.OnFragmentInteractionListener listener;

    public MyGameRecyclerViewAdapter(List<Game> games, GameFragment.OnFragmentInteractionListener listener) {
        this.games = games;
        this.listener =listener;
    }

    @Override
    public MyGameRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
